...
# Leave this chunk as is.  It creates a directory for the R package and then 
# sets things up so that code from this document ends up in the R package:
package_name <- params$package_name
setup_chunk_label <- knitr::opts_current$get("label")
litr::setup(package_name)
```
