...
tibble(
  ...
  transmute(
    ...
    `Generated html` = as.character(str_glue(paste0(
  ...
  mutate(`Rmd source file` = if_else(str_detect(`Rmd source file`, "create-cssr.Rmd"),
                                    "[index.html](https://github.com/gregfaletto/cssr-project/blob/main/index.Rmd)",
                                    `Rmd source file`)) %>%
  mutate(`Generated html` = if_else(str_detect(`Generated html`, "create-cssr.html"),
