...
#' @export
render <- function(input, minimal_eval = FALSE, ...) {
  ...
  if (litr_format) {
    ...
    if (output_format_arg & minimal_eval) {
    ...
    args$output_options$minimal_eval <- minimal_eval
