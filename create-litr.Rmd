...
**After the release of v0.0.3, let's add a package_doc block here.**
...
The above also makes use of a simple helper function that inserts text into a specified location of a file (or creates that file if it doesn't exist).
