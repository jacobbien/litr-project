...
# I'm just here to make devtools output print properly in HTML files
...
We need to use `pkgload` to avoid a bug caused by how `devtools::install` unloads a package.
```{r}
