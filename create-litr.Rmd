...
The next function could have been defined in a single line: `litr_pdf_document <- litrify_output_format(rmarkdown::pdf_document, minimal_eval = minimal_eval)`
...
load_all <- function(input, output_dir = NULL, ...) {
  ...
  copied_dir_name <- input_path[length(input_path) - 1]
  moved_input <- file.path(output_dir,
                           #copied_dir_name, 
                           fs::path_file(input))
