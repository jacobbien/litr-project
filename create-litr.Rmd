...
insert_hrefs <- function(txt, function_pattern, where_defined,
  ...
  has_colon_prefex <- which(stringr::str_detect(txt, paste0("::", function_pattern)))
  has_only_fn_name <- setdiff(has_fn_name, has_colon_prefex)
  ...
  colon_prefix_refs <- stringr::str_replace_all(
    txt[has_colon_prefex],
    paste0(stringr::str_glue("{pkg_name}::"), function_pattern),
    colon_pref_replace_fn
  )
  # Hack b/c can't pass pkg_name into colon_pref_replace_fn
  colon_prefix_refs <- stringr::str_replace_all(colon_prefix_refs, "PKG_NAME::",
                                                stringr::str_glue("{pkg_name}::"))
  ...
  txt[has_colon_prefex] <- colon_prefix_refs
